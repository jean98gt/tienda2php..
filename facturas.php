...
<html>
      <head>
        ...
        <script type="text/javascript">
            function ajax() {
                var d = document.getElementById("Número factura").value;
                const xmlhttp = new XMLHttpRequest();
                xmlhttp.onload = function () {
                    try {
                        myObj = JSON.parse(this.responseText);//[1013,Juan,Milena,Herrera,García,jua@h.com]
                        document.getElementById("Fecha").value = myObj[1];
                        document.getElementById("Documento cliente").value = myObj[2];
                        document.getElementById("Documento empleado").value = myObj[3];
                        
                    } catch (e) {
                        document.getElementById("Fecha").value = "";
                        document.getElementById("Documento cliente").value = "";
                        document.getElementById("Documento empleado").value = "";
            ...
            function enviarF(accion) {
                ...
                form.action = "controlador/facturasc.php?accion=" + accion;
                var cd = document.getElementById("Número factura");
                var p = document.getElementById("Fecha");
                var f = document.getElementById("Documento cliente");
                var f = document.getElementById("Documento empleado");
                var sub = true;
                if (accion == "Guardar") {
                    if (d.value == "") {
                        sub = false;
    ...
    <body>
        ...
        <form action="" method="post" name="enviar">
            <table id="tabla1" class="table table-hover table-bordered">
                <tr>
                    <td><label for="Número factura" class="form-label">Número factura</label></td>
                    <td><input type="number" class="form-control" id="Número factura" name="Número factura" ></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><label for="Documento cliente" class="form-label">Documento cliente</label></td>
                    <td><input type="text" class="form-control" id="Documento cliente" name="Documento cliente"></td>
                </tr>
              <tr>
                    <td><label for="Documento empleado" class="form-label">Documento empleado</label></td>
                    <td><input type="text" class="form-control" id="Documento empleado" name="Documento empleado"></td>
                </tr>  
